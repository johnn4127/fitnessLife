			...
			<section>
				<div style={{ backgroundColor: '#1f2937' }} className="dark:bg-violet-400">
					<div style={{ color: 'white' }} className="container flex flex-col items-center px-4 py-16 pb-24 mx-auto text-center lg:pb-56 md:py-32 md:px-10 lg:px-32 dark:text-gray-900">
						...
						<h2 style={{ color: 'white', fontSize:'x-large' }} className="mt-6 mb-8 text-lg sm:mb-12 xl:max-w-3xl dark:text-gray-900"> Discover new workouts and find the workout that's right for you! You'll find both visual and detailed instructions for each workout. <br /> <br /> Don't know where to start? We've already created a weekly planner just for you! <br /> <br /> This planner includes a workout schedule where you can easily locate the workouts you're looking for in the 'Specific Workouts' tab.</h2>
					</div>
				</div>
