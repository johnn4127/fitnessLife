...
const Homepage = () => {
  ...
  return (
	...
	<div className="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
		<img src="https://media.licdn.com/dms/image/D5603AQFi2FIUQubuwQ/profile-displayphoto-shrink_800_800/0/1697126047517?e=1702512000&v=beta&t=pIvIIn48jXcIdlhZuG7VlkDQAopFaLTsY0MWyjQATR4" alt="" className="self-center flex-shrink-0 w-24 h-24 border rounded-full md:justify-self-start dark:bg-gray-500 dark:border-gray-700" />
	...
	<div className="flex justify-center pt-4 space-x-4 align-center">
		...
		<a rel="noopener noreferrer" href="johnn4127@gmail.com" aria-label="Email" className="p-2 rounded-md dark:text-gray-100 hover:dark:text-violet-400">
			<svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-current">
